...
class LobbyChat extends Area
{
	...
	constructor()
	{
		...
		var alert = 'Большинство угонов аккаунтов происходит из-за слишком простых паролей. Задумывайтесь над этим, сделайте пароль сложнее, чаще его меняйте! Защитите свой аккаунт от злоумышленников';
		this.messages = [
		{
			"rangTo": 0,
			"addressed": false,
		...
		var prompt = 'Сервер запущен ' + day + "." + month + "." + date.getFullYear() + " в " + date.getHours() + ":" + minute;
		this.messages = [
		{
			"rangTo": 0,
			"addressed": false,
		...
		{
			"date": "19.01.2023",
                        "header": "%USERNAME%, наш проект открылся!",
			"text": "В честь этого на НЕДЕЛЮ мы вводим:/n-x3 фонды в битвах./n-Золотые ящики номиналом в 2000 кристаллов./n-Скидки в магазине на Пушки и Корпуса 40%./nУдачного праздника, танкисты!",
			"image": "https://media.discordapp.net/attachments/754997658577534978/981122446646181888/hornet_railgun2.png",
                        "id": 101
		}];
