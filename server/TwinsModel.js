...
class TwinsModel extends WeaponModel {
...
var tank = socket.tank;
            ...
            if (user !== null) {
                user.attack(killer, damage, socket.tank.garage.mounted_turret,  this.battle.getUser(tank.name).team_type.toUpperCase());
            }
